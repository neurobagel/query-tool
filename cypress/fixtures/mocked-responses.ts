...
const protectedDatasetSnippet = {
  ...
  repository_uri: 'https://hello.dataset.portal',
...
const unprotectedDatasetSnippet = {
  ...
  dataset_name: 'some\ndataset',
  repository_uri: 'https://github.com/OpenNeuroDatasets-JSONLD/ds004116.git',
...
export const datasetWithUnknownModality = {
  ...
  repository_uri: 'https://example.com/dataset',
...
export const datasetWithIncompleteModality = {
  ...
  repository_uri: 'https://example.com/dataset-incomplete',

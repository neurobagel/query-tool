...
describe("DownloadResultButton", () => {
    it("Displays an enabled MUI Button with the identifier passed as prop", () => {
        cy.mount(<DownloadResultButton identifier={props.identifier} disabled={props.disabled} handleClick={props.handleClick} />);
    ...
    it("Fires the handleClick event handler with the appropriate payload when the button is clicked", () => {
        ...
        cy.mount(<DownloadResultButton identifier={props.identifier} disabled={props.disabled} handleClick={handleClick} />);

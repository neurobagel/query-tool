...
for file in /app/dist/*.js; do
  ...
  sed -i "s|REPLACEME_NB_QUERY_CLIENT_ID_REPLACEME|${NB_QUERY_CLIENT_ID:-testclient1234}|g" "$file"
  sed -i "s|REPLACEME_NB_ENABLE_CHATBOT_REPLACEME|${NB_ENABLE_CHATBOT:-false}|g" "$file"
  sed -i "s|REPLACEME_NB_QUERY_APP_BASE_PATH_REPLACEME|${NB_QUERY_APP_BASE_PATH:-/}|g" "$file"
